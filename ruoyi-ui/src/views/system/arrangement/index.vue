<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="始点" prop="startLocation">
        <el-input
      ...
      <el-form-item label="开始仿真模拟时间" prop="startTime">
        <el-date-picker clearable
          v-model="queryParams.startTime"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="请选择开始仿真模拟时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="结束仿真模拟时间" prop="endTime">
        <el-date-picker clearable
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="始点" prop="startLocation">
          <el-input v-model="form.startLocation" placeholder="请输入始点" />
        </el-form-item>
        <el-form-item label="终点" prop="endLocation">
