<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="windTurbineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="模型" align="center" prop="tModel" />
      <el-table-column label="价格" align="center" prop="tPrice" />
      <el-table-column label="功率" align="center" prop="tRatePower" />
      <el-table-column label="功率速度曲线" align="center" prop="tPowerVelocityCurve" />
      <el-table-column label="高度" align="center" prop="tHeight" />
      <el-table-column label="寿命" align="center" prop="tLifetime" />
      <el-table-column label="成本" align="center" prop="tCost" />
      ...
      <el-table-column label="故障状态" align="center" prop="tFaultState">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.lt_turbine_fault" :value="scope.row.tFaultState"/>
        </template>
      </el-table-column>
      <el-table-column label="保养状态" align="center" prop="tMaintainState">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.lt_turbine_maintain" :value="scope.row.tMaintainState"/>
        </template>
      </el-table-column>
